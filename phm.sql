...
CREATE TABLE `participants` (
  `neighbors_id` int(11) NOT NULL,
  `events_id` int(11) NOT NULL,
  PRIMARY KEY (`neighbors_id`,`events_id`),
  KEY `fk_neighbors_has_events_events1_idx` (`events_id`),
  KEY `fk_neighbors_has_events_neighbors1_idx` (`neighbors_id`),
  CONSTRAINT `fk_neighbors_has_events_events1` FOREIGN KEY (`events_id`) REFERENCES `events` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_neighbors_has_events_neighbors1` FOREIGN KEY (`neighbors_id`) REFERENCES `neighbors` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `suggestions` VALUES (1,'2016-07-19 10:00:00','Deberian renovar las pistas de la avenida principal',1),(2,'2016-07-19 14:58:57','Deberian renovar las pistas de la avenida principal',1);
...
-- Dump completed on 2016-08-06  2:48:35
