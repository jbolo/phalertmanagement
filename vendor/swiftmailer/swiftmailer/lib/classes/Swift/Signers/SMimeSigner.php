...
class Swift_Signers_SMimeSigner implements Swift_Signers_BodySigner
{
    ...
    /**
     * Set the certificate locations to use for signing.
     *
     * @link http://www.php.net/manual/en/openssl.pkcs7.flags.php
     *
     * @param string       $certificate
     * @param string|array $privateKey  If the key needs an passphrase use array('file-locations', 'passphrase') instead
    ...
    /**
     * Set the certificate locations to use for encryption.
     *
     * @link http://www.php.net/manual/en/openssl.pkcs7.flags.php
